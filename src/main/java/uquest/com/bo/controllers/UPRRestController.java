...
//    }
    ...
    public ResponseEntity<?> creates(@Valid @RequestBody List<UPR> upr, BindingResult result) {
...
//            }
        ...
        response.put("upr", uprNew);
        response.put("mensaje", "Se realizo el registro de upr multiple correctamente");
        return new ResponseEntity<Map>(response, HttpStatus.CREATED);
    }
}
